...
// openAIPassthroughRollbackError signals that the passthrough path detected a
// "missing instructions" rejection before any response was written to the client.
// The caller should roll back to the non-passthrough (full transform) path.
